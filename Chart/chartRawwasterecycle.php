...
$queryResult2 = $conn->query("SELECT DISTINCT(waste_month) ,
...
$queryResult3 = $conn->query("SELECT DISTINCT(waste_month) ,
...
$queryResult4 = $conn->query("SELECT DISTINCT(waste_month) ,
