...
$sql3 =  "'" . $year . "' ";
$sql4 =  "'" . $eg_name . "' ";
$queryResult = $conn->query("SELECT `eg_month`, `eg_unit`, `eg_unit_eq`, `eg_name` FROM tb_energy_touse where `eg_month` >= $sql1 AND `eg_month` <= $sql2 AND `eg_year` = $sql3 
