...
$queryResult4 = $conn->query("SELECT tb_use_waters.water_month, tb_use_waters.water_cubic, tb_use_waters.water_cubic_eq, tb_use_waters.water_name, tb_month.mon_name 
...
$queryResult5 = $conn->query("SELECT tb_use_waters.water_month, tb_use_waters.water_cubic, tb_use_waters.water_cubic_eq, tb_use_waters.water_name, tb_month.mon_name 
    FROM tb_use_waters, tb_month 
    WHERE tb_use_waters.water_month = tb_month.mon_id AND tb_use_waters.water_month >= $sql1 AND tb_use_waters.water_month <= $sql2 AND tb_use_waters.water_year = $sql3 AND tb_use_waters.water_name = $sql4
     ORDER BY tb_use_waters.water_month ASC");
    ...
    <script>
        window.onload = function() {
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                theme: "light2",
                title: {
                    text: "กราฟแสดงข้อมูลการใช้น้ำRO"
                },
                axisY: {
                    includeZero: true
                },
